...
if os.path.exists(train_file_path):
    print(f"Training file found: {train_file_path}")
else:
    print(f"Training file not found: {train_file_path}")

if os.path.exists(test_file_path):
    print(f"Testing file found: {test_file_path}")
else:
    print(f"Testing file not found: {test_file_path}")
...
if os.path.exists(train_file_path) and os.path.exists(test_file_path):
    ...
    print("One or both files are missing. Please check the file paths.")
...
train_file_path = 'path_to_your_directory/Renewable_Training.csv'
